...
<execution_context>
@D:/project/mcp/web-crawler/.claude/get-shit-done/workflows/pr-branch.md
</execution_context>

<process>
Execute the pr-branch workflow from @D:/project/mcp/web-crawler/.claude/get-shit-done/workflows/pr-branch.md end-to-end.
</process>
