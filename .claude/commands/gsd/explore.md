...
<execution_context>
@D:/project/mcp/web-crawler/.claude/get-shit-done/workflows/explore.md
</execution_context>

<process>
Execute the explore workflow from @D:/project/mcp/web-crawler/.claude/get-shit-done/workflows/explore.md end-to-end.
</process>
