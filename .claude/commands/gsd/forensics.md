...
<execution_context>
@D:/project/mcp/web-crawler/.claude/get-shit-done/workflows/forensics.md
</execution_context>
...
<process>
Read and execute the forensics workflow from @D:/project/mcp/web-crawler/.claude/get-shit-done/workflows/forensics.md end-to-end.
</process>
