...
<execution_context>
@D:/project/mcp/web-crawler/.claude/get-shit-done/workflows/execute-phase.md
...
<process>
Execute the execute-phase workflow from @D:/project/mcp/web-crawler/.claude/get-shit-done/workflows/execute-phase.md end-to-end.
