...
<execution_context>
@D:/project/mcp/web-crawler/.claude/get-shit-done/workflows/code-review-fix.md
</execution_context>
...
Execute the code-review-fix workflow from @D:/project/mcp/web-crawler/.claude/get-shit-done/workflows/code-review-fix.md end-to-end.
