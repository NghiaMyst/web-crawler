...
<execution_context>
@D:/project/mcp/web-crawler/.claude/get-shit-done/workflows/session-report.md
</execution_context>

<process>
Execute the session-report workflow from @D:/project/mcp/web-crawler/.claude/get-shit-done/workflows/session-report.md end-to-end.
</process>
