...
Reference full template: `D:/Experience/SideProj/web-crawler/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `D:/Experience/SideProj/web-crawler/.claude/get-shit-done/templates/state.md`.
