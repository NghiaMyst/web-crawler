...
Reference full template: `D:/project/mcp/web-crawler/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `D:/project/mcp/web-crawler/.claude/get-shit-done/templates/state.md`.
