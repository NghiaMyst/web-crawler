...
Use template from `D:/project/mcp/web-crawler/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `D:/project/mcp/web-crawler/.claude/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "D:/project/mcp/web-crawler/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
