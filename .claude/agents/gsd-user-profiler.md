...
<reference>
@D:/project/mcp/web-crawler/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `D:/project/mcp/web-crawler/.claude/get-shit-done/references/user-profiling.md` to load:
