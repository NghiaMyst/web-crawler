...
<reference>
@D:/Experience/SideProj/web-crawler/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `D:/Experience/SideProj/web-crawler/.claude/get-shit-done/references/user-profiling.md` to load:
